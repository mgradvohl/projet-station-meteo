...
class MainWin:
    def __init__(self, top=None):
        ...
        self.PTexteBourrage = tk.Label(self.FramePMes)
        self.PTexteBourrage.place(x=340, y=210, height=181, width=254
                , bordermode='ignore')
        self.PTexteBourrage.configure(activebackground="#f9f9f9")
        self.PTexteBourrage.configure(activeforeground="black")
        self.PTexteBourrage.configure(anchor='nw')
        self.PTexteBourrage.configure(background="#d9d9d9")
        self.PTexteBourrage.configure(disabledforeground="#a3a3a3")
        self.PTexteBourrage.configure(font="-family {Segoe UI} -size 9")
        self.PTexteBourrage.configure(foreground="#000000")
        self.PTexteBourrage.configure(highlightbackground="#d9d9d9")
        self.PTexteBourrage.configure(highlightcolor="black")
        self.PTexteBourrage.configure(justify='left')
        self.PTexteBourrage.configure(relief="sunken")
        self.PTexteBourrage.configure(text='''Texte''')
